    ...
    <main className={styles.main}>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.text}>
          Ця Політика конфіденційності визначає порядок отримання, зберігання,
          обробки та використання персональних даних користувачів сайту
          t-mebel.com.ua (далі — «Сайт»).
        </p>
      </section>
      <section className={styles.section}>
        <h2 className={styles.subtitle}>2. Збір та використання інформации</h2>
        <p className={styles.text}>
          Ми збираємо лише ті персональні дані, які ви добровільно надаєте при
          використанні Сайту (наприклад, при оформленні замовлення, реєстрації,
      ...
      <section className={styles.section}>
        ...
        <p className={styles.text}>
          ...
          даних від несанкціонованого доступу, зміни, розголошення або знищення.
        </p>
      </section>
      <section className={styles.section}>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.text}>
          ...
          набирають чинності з моменту їх публікації на Сайті.
        </p>
      </section>
      <section className={styles.section}>
